# helper library for path_follower
gcode_header = """; generated by PrusaSlicer 2.5.0+win64 on 2022-12-15 at 16:09:16 UTC
...
; purge line
G1 Y8.0 X0.0 Z0.3 F1500.0 ; go to edge of print area and .3mm high to start .6mm nozzle purge line
G92 E0.0; reset extruder
M83; set extruder to relative mode
G1 X50.0 E12.0 F800.0 ; intro line. Adjust the "E12" down a bit if needed
G1 X120.0 E20.0 F800.0 ; thicker intro line
G1 E-1.000 F1800; retract 1mm
;G1 X146.0 F3200; wipe backwards 4mm
G92 E0.0;reset extruder
...
; bed_custom_model = 
; bed_custom_texture = T:\\Documents\\3D Printer\\Media\\voxelab base.png
...
; end_gcode = M104 S0 ; turn off temperature\\nM140 S0 ; turn off temperature\\nG28 X0  ; home X axis\\nG1 Y200 ; added by tanmay, move print bed ahead\\nM84     ; disable motors\\n
...
; filament_settings_id = "eSun PETG"
; filament_soluble = 0
...
; perimeter_speed = 75
; perimeters = 3
; physical_printer_settings_id = OctoAquila
; post_process = 
; print_settings_id = 0.8 Strong
; printer_model = 
; printer_notes = 
; printer_settings_id = Voxelab Aquila 0.8
...
; start_gcode = G28 ; home all axes\\nG1 Z5 F5000 ; lift nozzle\\n\\nM140 S[first_layer_bed_temperature]; set bed temp\\nM190 S{first_layer_bed_temperature[0]-20}; wait for bed temp\\nM104 S[first_layer_temperature]; set extruder temp\\nM190 S[first_layer_bed_temperature]; wait for bed temp\\nM109 S[first_layer_temperature]; wait for extruder temp\\n\\n; purge line\\nG1 Y8.0 X0.0 Z0.3 F1500.0 ; go to edge of print area and .3mm high to start .6mm nozzle purge line\\nG92 E0.0; reset extruder\\nM83; set extruder to relative mode\\nG1 X50.0 E12.0 F800.0 ; intro line. Adjust the "E12" down a bit if needed\\nG1 X120.0 E20.0 F800.0 ; thicker intro line\\nG1 E-1.000 F1800; retract 1mm\\n;G1 X146.0 F3200; wipe backwards 4mm\\nG92 E0.0;reset extruder\\nM82; set to absolute mode
; support_material = 0
